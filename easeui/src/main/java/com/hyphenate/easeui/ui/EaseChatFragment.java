...
//        messageList.setAvatarShape(1);
    ...
    void onCameraDenied() {
        ...
        Toast.makeText(this.getContext(), R.string.permission_camera_denied, Toast.LENGTH_SHORT).show();
    }
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                case ITEM_TAKE_PICTURE:
                    EaseChatFragmentPermissionsDispatcher.onCameraAllowWithCheck(EaseChatFragment.this);
//                    selectPicFromCamera();
                    break;
                case ITEM_PICTURE:
                    selectPicFromLocal();
    ...
    protected void selectPicFromCamera() {
        ...
        Uri photoURI = FileProvider.getUriForFile(getActivity(), "com.shuhai.anfang.fileProvider", cameraFile);
