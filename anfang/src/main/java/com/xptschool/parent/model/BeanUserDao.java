...
/** 
 * DAO for table "BEAN_USER".
*/
public class BeanUserDao extends AbstractDao<BeanUser, Void> {

    public static final String TABLENAME = "BEAN_USER";

    /**
     * Properties of entity BeanUser.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Head_portrait = new Property(6, String.class, "head_portrait", false, "HEAD_PORTRAIT");
        public final static Property Ref_id = new Property(7, String.class, "ref_id", false, "REF_ID");
        public final static Property Type = new Property(8, String.class, "type", false, "TYPE");
    };


    public BeanUserDao(DaoConfig config) {
        super(config);
    }
    
    public BeanUserDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BEAN_USER\" (" + //
                "\"NAME\" TEXT," + // 0: name
                ...
                "\"PHONE\" TEXT," + // 4: phone
                "\"EMAIL\" TEXT," + // 5: email
                "\"HEAD_PORTRAIT\" TEXT," + // 6: head_portrait
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BEAN_USER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BeanUser entity) {
        stmt.clearBindings();
        ...
        if (head_portrait != null) {
            stmt.bindString(7, head_portrait);
        }
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BeanUser entity) {
        stmt.clearBindings();
    ...
    @Override
    public BeanUser readEntity(Cursor cursor, int offset) {
        BeanUser entity = new BeanUser( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // head_portrait
    ...
    @Override
    public void readEntity(Cursor cursor, BeanUser entity, int offset) {
        ...
        entity.setHead_portrait(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
    ...
    @Override
    protected final Void updateKeyAfterInsert(BeanUser entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(BeanUser entity) {
        return null;
    }
