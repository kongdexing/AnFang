...
public class HomeWorkParentActivity extends BaseListActivity {
    ...
    private void initView() {
        ...
        adapter = new HomeWorkParentAdapter(this);
                            ...
                            case HttpAction.SUCCESS:
                                try {
                                    ...
                                    if (resultPage.getPage() > 1) {
                                        ...
                                        //第一页数据
                                        if (homeWorks.size() == 0) {
                                            Toast.makeText(HomeWorkParentActivity.this, R.string.toast_data_empty, Toast.LENGTH_SHORT).show();
                                        }
                                    ...
                                    Toast.makeText(HomeWorkParentActivity.this, HttpErrorMsg.ERROR_JSON, Toast.LENGTH_SHORT).show();
                                }
                                break;
                            default:
                                Toast.makeText(HomeWorkParentActivity.this, httpResult.getInfo(), Toast.LENGTH_SHORT).show();
                                break;
                        }
                    }
