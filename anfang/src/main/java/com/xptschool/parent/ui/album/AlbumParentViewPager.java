...
public class AlbumParentViewPager extends ViewPager implements MatrixImageView.OnMovingListener {
    ...
    private class ProcessListener implements ImageLoadingProgressListener {
...
//			view.getParent().bringChildToFront(view);
     ...
     * 播放按钮点击事件
     */
    public AlbumParentViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public class LocalViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int position) {
            ...
            imageView.setOnMovingListener(AlbumParentViewPager.this);
    ...
    public class NetViewPagerAdapter extends PagerAdapter {
        ...
        public NetViewPagerAdapter(List<String> paths) {
            this.paths = paths;
        }
