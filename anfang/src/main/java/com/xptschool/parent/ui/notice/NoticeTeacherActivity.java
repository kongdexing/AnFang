    ...
    private void initView() {
        ...
        setTextRightClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NoticeTeacherActivity.this, NoticeDetailTActivity.class));
            }
        });
    }
                            ...
                            case HttpAction.SUCCESS:
                                try {
                                    ...
                                    if (resultPage.getPage() > 1) {
                                        ...
                                        //第一页数据
                                        if (notices.size() == 0) {
                                            Toast.makeText(NoticeTeacherActivity.this, R.string.toast_data_empty, Toast.LENGTH_SHORT).show();
                                        }
                                    ...
                                    Toast.makeText(NoticeTeacherActivity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                                break;
                        }
                    }
