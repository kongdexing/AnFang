...
import com.xptschool.parent.ease.domain.EmojiconExampleGroupData;
import com.xptschool.parent.ease.domain.RobotUser;
import com.xptschool.parent.ease.widget.ChatRowVoiceCall;
import com.xptschool.parent.ease.widget.EaseChatRowRecall;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return super.onCreateView(inflater, container, savedInstanceState,
                EaseHelper.getInstance().getModel().isMsgRoaming() && (chatType != EaseConstant.CHATTYPE_CHATROOM));
    }
    ...
    public boolean onExtendMenuItemClick(int itemId, View view) {
        switch (itemId) {
            ...
            case ITEM_VOICE_CALL:
                //语音通话,判断录音权限
                ChatFragmentPermissionsDispatcher.onVoiceAllowWithCheck(ChatFragment.this);
//                startVoiceCall();
                break;
...
//            });
    ...
    */
    ...
    void onVoiceAllow() {
        Log.i(TAG, "onVoiceAllow: startVoiceCall()");
        startVoiceCall();
    }

    @OnPermissionDenied(Manifest.permission.RECORD_AUDIO)
    void onVoiceDenied() {
        Log.i(TAG, "onVoiceDenied: ");
    ...
    void showRationaleForVoice(PermissionRequest request) {
        // NOTE: Show a rationale to explain why the permission is needed, e.g. with a dialog.
        // Call proceed() or cancel() on the provided PermissionRequest to continue or abort
        Log.i(TAG, "showRationaleForVoice: ");
        request.proceed();
    }
