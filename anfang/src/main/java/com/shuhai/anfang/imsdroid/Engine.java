...
//    private IScreenService mScreenService;
    ...
    private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        Intent intent = new Intent(XPTApplication.getInstance(), MainActivity.class);
        ...
        switch (notifId) {
            ...
            case NOTIF_CONTSHARE_ID:
                intent.putExtra("action", Engine.ACTION_SHOW_CONTSHARE_SCREEN);
            ...
            case NOTIF_SMS_ID:
                ...
                intent.putExtra("action", Engine.ACTION_SHOW_SMS);
                break;

            case NOTIF_AVCALL_ID:
                tickerText = String.format("%s (%d)", tickerText, NgnAVSession.getSize());
                intent.putExtra("action", Engine.ACTION_SHOW_AVSCREEN);
                break;
            ...
            case NOTIF_CHAT_ID:
                ...
                intent.putExtra("action", Engine.ACTION_SHOW_CHAT_SCREEN);
                break;
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(XPTApplication.getInstance(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);

        // Set the info for the views that show in the notification panel.
//        notification.setLatestEventInfo(XPTApplication.getContext(), CONTENT_TITLE, tickerText, contentIntent);
