package com.shuhai.anfang.ui.checkin;
...
import com.shuhai.anfang.bean.BeanCheckin;
...
import com.shuhai.anfang.view.CalendarView;
                            ...
                            case HttpAction.SUCCESS:
                                try {
                                    ...
                                    if (listCheckins.size() == 0) {
                                        ...
                                        Toast.makeText(CheckinTActivity.this, R.string.toast_data_empty, Toast.LENGTH_SHORT).show();
                                    } else {
                                    ...
                                    Toast.makeText(CheckinTActivity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                                break;
                            default:
                                Toast.makeText(CheckinTActivity.this, httpResult.getInfo(), Toast.LENGTH_SHORT).show();
                                break;
                        }
                    }
