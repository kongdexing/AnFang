package com.shuhai.anfang.ui.leave;
...
import com.shuhai.anfang.bean.BeanLeave;
 ...
 */
public class LeaveTAdapter extends BaseRecycleAdapter {

    private List<BeanLeave> beanLeaves = new ArrayList<>();

    public LeaveTAdapter(Context context) {
        super(context);
    }
    ...
    public RecyclerViewHolderBase onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_leave_t, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final LeaveTAdapter.ViewHolder mHolder = (LeaveTAdapter.ViewHolder) holder;
