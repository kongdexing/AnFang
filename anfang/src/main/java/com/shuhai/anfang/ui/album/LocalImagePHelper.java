...
import com.shuhai.anfang.common.StringUtils;
...
public class LocalImagePHelper {

    private static LocalImagePHelper instance;
    private static Context mContext;
    final List<LocalFile> checkedItems = new ArrayList<>();
    private String TAG = LocalImagePHelper.class.getSimpleName();
    //最大图片选择个数
    ...
    public static LocalImagePHelper getInstance() {
        synchronized (LocalImagePHelper.class) {
            if (mContext == null) {
                return null;
            }
            if (instance == null) {
                instance = new LocalImagePHelper();
            }
        }
        return instance;
    }
