...
*/
package com.shuhai.anfang.imsdroid.Services.Impl;

import android.app.Activity;
import android.util.Log;

import com.shuhai.anfang.imsdroid.Engine;
import com.shuhai.anfang.imsdroid.Services.IScreenService;
...
//        Intent intent = new Intent(XPTApplication.getContext(), ScreenAV.class);
//        try {
...
//            }
//            XPTApplication.getContext().startActivity(intent);
//            return true;
//        } catch (Exception e) {
//            e.printStackTrace();
//            return false;
