...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            backgroundColor = ta.getColor(R.styleable.MaterialSpinner_ms_background_color, getResources().getColor(R.color.color3));
            ...
            paddingLeft = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_left, left);
            ...
            popupWindowWidth = ta.getLayoutDimension(R.styleable.MaterialSpinner_ms_dropdown_width,
                    WindowManager.LayoutParams.WRAP_CONTENT);
...
//        popupWindow.setWidth(MeasureSpec.getSize(widthMeasureSpec));
        popupWindow.setWidth(calculatePopupWindowWidth(widthMeasureSpec));
    ...
    private int calculatePopupWindowWidth(int widthMeasureSpec) {
        if (adapter == null) {
